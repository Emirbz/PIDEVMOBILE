...
public class UserService {
    ...
    public void register(String username,String email, String password, String name,String surname, String address){
         ConnectionRequest con = new ConnectionRequest();
        //System.out.println(r.getDate());
        String Url = "http://localhost/PIDEV/web/app_dev.php/users/addUser?username=" + username + "&username_canonical=" + username.toLowerCase() + "&email=" + email + "&email_canonical=" + email.toLowerCase() + "&password=" + password + "&name=" + name+"&surname=" + surname+"&address=" + address;
        con.setUrl(Url);
